...
import br.gov.sp.sempapel.migracao.service.PreenchimentoService;

@RestController
@RequestMapping("/api/preenchimento")
public class PreenchimentoController {
	...
	public Map<String, String> status(){
		...
		try {
			return preenchimentoService.status();
		} catch (Exception e) {
			m.put("erro",e.getMessage());
		}
		return m;
